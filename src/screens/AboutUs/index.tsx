    ...
    <SafeAreaView style={styles.pagina}>
      ...
      >
          ...
          <View style={{gap: 20}}>
            ...
            <View style={{gap: 20}}>
              ...
              <View style={styles.linguagem}>
                ...
                <Text style={[styles.dadosStartup,{color: "#FFB100"}]}>NebuloHub</Text>
            ...
            >
              <Text style={styles.textOutroButton}>{t("buttons.visitGithub")}</Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={[styles.startupCard, { paddingBottom: 30, gap: 30 }]}>
          ...
          <View>
            <Text style={styles.dadosStartup}>{t("pages.StartupDetails.titleDesc")}</Text>
          </View>

          <View>
            <Text style={styles.textButton}>{t("text")}</Text>
          </View>
        ...
        <View style={[styles.startupCard, {gap:10, paddingBottom:30, marginBottom:0, marginTop:30, borderBottomWidth: 0, paddingHorizontal: 0,  }]}>

          <View style={{paddingHorizontal: 20, gap:10}}>

            <View style={styles.linguagem}>

              <Text style={[styles.dadosStartup, {fontSize:20}]}>{t("titles.faculty")}</Text>
              <Text style={[styles.dadosStartup, {color:"#ED1165", fontSize:20}]}>FIAP</Text>

            </View>
            <TouchableOpacity
              onPress={() => openLink("https://www.fiap.com.br")}
            >
              <Text style={[styles.dadosStartup, {color:"#ED1165", fontSize:20, textDecorationLine: "underline"}]}>fiap.com.br</Text>
            </TouchableOpacity>
          </View>
        ...
        <TouchableOpacity style={[styles.buttonProfile, { marginTop: 10, marginBottom: 40 }]} onPress={() => navigation.goBack()}>
